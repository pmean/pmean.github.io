...
+ Lecture example code
  + lecture-example-code-02-01.sas (import-space-delimited.sas), available in [text format](https://github.com/classes-medb/5507/blob/master/module02/src/lecture-example-code-02-01.sas). It shows how to import a space-delimited text file.
  + lecture-example-code-02-02.sas (import-space-delimited.sas), available in [text format](https://github.com/classes-medb/5507/blob/master/module02/src/lecture-example-code-02-01.sas). It shows how to import a space-delimited text file.
