...
This file was created by Steve Simon using R Markdown on 2020-06-27 and last updated on `r Sys.Date()`. You can find the source code on my github repository

Here are the overviews for each module of the class.

[Module01. Getting started](5507-overview-01.Rmd)
