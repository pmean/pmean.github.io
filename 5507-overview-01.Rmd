---
title: "MEDB 5507, Introduction to SAS. Overview of Module01"
---
    
This file was created by Steve Simon using R Markdown on 2020-09-24 and last updated on `r Sys.Date()`. You can find the source code on my github repository
...
+ V01-03. Your first SAS program (10 minutes). 
  ...
  + my-first-program.sas is available in [text format](https://github.com/classes-medb/5507/blob/master/module01/src/my-first-sas-program.sas).
...
+ V01-04. Storing SAS datasets using libname (12 minutes). 
  ...
  + Slides with speaker notes are not available.
  + permanent-storage.sas is available in [text format](https://github.com/classes-medb/5507/blob/master/module01/src/permanent-storage.sas).
  + re-use.sas is available in [text format](https://github.com/classes-medb/5507/blob/master/module01/src/re-use.sas).
...
+ V01-05. Storing SAS output using ODS (15 minutes). 
  ...
  + Slides with speaker notes are not available.
  + saved-pdf.sas is available in [text format](https://github.com/classes-medb/5507/blob/master/module01/src/saved-pdf.sas).
...
+ V01-06. Reading external data using infile and filename (13 minutes). 
  ...
  + Slides with speaker notes are not available.
  + input-text.sas is available in [text format](https://github.com/classes-medb/5507/blob/master/module01/src/input-text.sas).
